...
export class PrincipalPage {
  ...
  getVagasArquivadas() {
    try {
      ...
      this.vagaService.findVagaFinalizadasFornecedorByVaga()
        .then((vagasDetalheEntityResult: VagaDetalheEntity) => {
          this.vagasAtivas = vagasDetalheEntityResult;
    ...
    try {
      ...
      this.vagaService.findVagaFornecedorByVaga(this.vagaDetalheEntity)
        .then((vagasListaEntityResult: VagaListaEntity) => {
          ...
          console.log(this.vagasAtivas);
          // let index = this.vagasAtivas.indexOf(vagasListaEntityResult);
          // if(index > -1){
          //   this.vagasAtivas.splice(index, 1);
          // }
          this.qtdVagasAtivas = this.vagasAtivas.length
  ...
  doInfinite() {
    ...
    console.log(this.vagasAtivas);
    console.log(this.vagasAtivas.length);
