...
import {DomSanitizer, DomSanitizationService} from '@angular/platform-browser';
  ...
  getDetalheCandidatoVaga() {
    try {
      ...
      .then((usuarioDetalheVagaEntityResult: UsuarioDetalheVagaEntity) => {
        ...
        let image = this.sanitization.bypassSecurityTrustStyle(`url(${this.usuarioDetalheVagaEntity.imagemPessoaBs64})`);
