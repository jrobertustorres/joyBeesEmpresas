  ...
  getDetalheCandidatoVaga() {
    try {
      ...
      .then((usuarioDetalheVagaEntityResult: UsuarioDetalheVagaEntity) => {
        ...
        let image = this.sanitizer.bypassSecurityTrustResourceUrl('data:image/jpg;base64,' 
        + this.usuarioDetalheVagaEntity.imagemPessoaBs64);
        console.log(this.usuarioDetalheVagaEntity.imagemPessoaBs64);
        
        // let image = this.usuarioDetalheVagaEntity.imagemPessoaBs64;
        // let image = this.sanitizer.bypassSecurityTrustStyle(`url(${this.usuarioDetalheVagaEntity.imagemPessoaBs64})`);
        // console.log(image);
        // let image = this.sanitization.bypassSecurityTrustStyle(`url(${element.image})`);
        // let sanitizedUrl = this.sanitizer.bypassSecurityTrustUrl('data:image/png;base64,'+this.usuarioDetalheVagaEntity.imagemPessoaBs64);
