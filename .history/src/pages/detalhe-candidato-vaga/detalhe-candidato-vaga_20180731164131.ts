  ...
  getDetalheCandidatoVaga() {
    try {
      ...
      .then((usuarioDetalheVagaEntityResult: UsuarioDetalheVagaEntity) => {
        ...
        this.usuarioDetalheVagaEntity.genero = this.usuarioDetalheVagaEntity.nacionalidade.charAt(0).toUpperCase() + this.usuarioDetalheVagaEntity.nacionalidade.slice(1).toLowerCase();
        console.log(this.usuarioDetalheVagaEntity.nacionalidade);
