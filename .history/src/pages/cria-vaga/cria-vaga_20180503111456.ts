...
export class CriaVagaPage {
  ...
  public selecionaDataFinal() {
    ...
    .then(dataFinal => {
      ...
      // this.dataFinalFormat = this.vagaDetalheEntity.dataFinalFormat;
    ...
    try {
      ...
      this.vagaService.findVagaDetalhe(this.vagaDetalheEntity)
        .then((vagaDetalheEntityResult: VagaDetalheEntity) => {
          ...
          this.dataFinalFormat = new Date().toJSON().split('T')[0];
          // let date= new Date().toISOString()
          // let startDate: string = new Date().toISOString();
          // this.dataFinalFormat = startDate;
          // this.dataFinalFormat = this.vagaDetalheEntity.dataFinalFormat;
          // console.log(this.dataFinalFormat);
          // let dataFinalFormat = new Date(this.vagaDetalheEntity.dataFinal).toLocaleDateString();
          // this.vagaDetalheEntity.dataFinal = dataFinalFormat;
