...
export class CriaVagaPage {
  ...
  insereVaga() {
    ...
    this.criaVagaForm.value.salarioHomem = this.criaVagaForm.value.salarioHomem ? this.criaVagaForm.value.salarioHomem.replace(",", "") : null;
    this.criaVagaForm.value.salarioMulher = this.criaVagaForm.value.salarioMulher ? this.criaVagaForm.value.salarioMulher.replace(",", "") : null;
