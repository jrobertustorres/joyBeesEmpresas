    ...
    try {
      ...
      this.vagaService.findVagaDetalhe(this.vagaDetalheEntity)
        .then((vagaDetalheEntityResult: VagaDetalheEntity) => {
          ...
          this.vagaDetalheEntity.dataFinalFormat = new Date(this.vagaDetalheEntity.dataFinalFormat).toJSON().split('T')[0];
          // this.vagaDetalheEntity.dataFinalFormat = new Date().toJSON().split('T')[0];
