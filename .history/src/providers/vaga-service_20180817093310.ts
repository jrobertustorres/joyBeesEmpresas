...
export class VagaService {
  ...
  public findVagaFinalizadasFornecedorByVagaFilter(vagaDetalheEntity) {
    try {

      return new Promise((resolve, reject) => {
        this.http.post(Constants.API_URL  + 'findVagaFinalizadasFornecedorByVagaFilter/'
        + localStorage.getItem(Constants.TOKEN_USUARIO), JSON.stringify(vagaDetalheEntity), this.options)
          .map(res=>res.json())
          .subscribe(data => {
            resolve(data);
  ...
  public duplicarVaga(vagaDetalheEntity) {
    try {

      return new Promise((resolve, reject) => {
        this.http.post(Constants.API_URL  + 'duplicarVaga/'
        + localStorage.getItem(Constants.TOKEN_USUARIO), JSON.stringify(vagaDetalheEntity), this.options)
          .map(res=>res.json())
          .subscribe(data => {
            resolve(data);
